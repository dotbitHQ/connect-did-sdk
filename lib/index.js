...
exports.ConnectDID = exports.EnumResponseMethods = exports.EnumRequestMethods = exports.ActionErrorCode = exports.DeviceAuthError = void 0;
...
class ConnectDID {
    ...
    open(origin, params, isNewTab, isEncode = true) {
        ...
        try {
            return globalThis.open(`${origin}#${hash}`, this.serviceID, !isNewTab
